...
import uk.ac.ncl.ziyu.checkConnection.Connect;
import uk.ac.ncl.ziyu.operation.Operation;
...
public class MainGUI {
	...
	private JTextField textInterestName;
	private JTextField textRecommendation;
	private JTable tableInterest;
	private JTable tableRecommendation;
	private JTable tableCountVandalism;
	...
	public MainGUI() {
		try{
			Connect.checkDatabaseIsRunning();
			initialize();
			}catch(Exception e){
				this.frmCreatingAProvenance=ErrorMessage.generateErrorMessage();
	...
	private void initialize() {
		...
		btnSubmitArticle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Operation.queryByArticle(title, revlimit, depth, uclimit);
					System.err.println(Calendar.getInstance().getTime());
				} catch (Exception e1) {
		...
		btnSubmitUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int depth = Integer.parseInt(depthString);
				try {
					Operation.queryByUser(user, uclimit, depth, revlimit);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}			
		...
		buttonDeleteNodeAndRelationship.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(null, "You will delete all nodes, relationships and indexes from the Neo4j, are you sure?", "Delete",
	                    JOptionPane.YES_NO_OPTION);
				if(result==JOptionPane.YES_OPTION){
					Operation.deleteRelationshipAndNode();
					Operation.deleteIndex();
				}
			}
		});
		...
		btnShowAllVandalism.addActionListener(new ActionListener() {
			...
			//	String allVandalism = new String(); 
				...
				int counter=0;
					...
					try {
						resultList = Operation.showAllVandalism();
				...
				tableAllVandalism.getColumnModel().getColumn(0).setPreferredWidth(110);
				tableAllVandalism.getColumnModel().getColumn(2).setPreferredWidth(130);
				tableAllVandalism.getColumnModel().getColumn(4).setPreferredWidth(100);
		...
		btnGoToHowManyVandalism.setEnabled(false);
		listenTable(tableAllVandalism, btnGoToHowManyVandalism);
		btnGoToHowManyVandalism.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableAllVandalism);
			}
		});
		btnGoToHowManyVandalism.setBounds(263, 46, 113, 23);
		...
		btnSubmitVandalism.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String folderPath = textFolerPathVandalism.getText();		
					try {
						Operation.GetVandalism(folderPath);
					} catch (ClientHandlerException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					} catch (UniformInterfaceException e1) {
...
//				labelCountUserVandalism.setText(count);
				...
				int counter=0;
					...
					try {
						resultList = Operation.showVandalismByUser(user);
						if(resultList.size()!=0){
							for(int i=0;i<resultList.size();i++){
								counter++;
								model.addRow(resultList.get(i));
					...
					tableVandalismByUser.getColumnModel().getColumn(0).setPreferredWidth(110);
					tableVandalismByUser.getColumnModel().getColumn(2).setPreferredWidth(130);
					tableVandalismByUser.getColumnModel().getColumn(4).setPreferredWidth(100);
		...
		btnGoToVandalismByUser.setEnabled(false);
		listenTable(tableVandalismByUser, btnGoToVandalismByUser);
		btnGoToVandalismByUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableVandalismByUser);
			}
		});
		btnGoToVandalismByUser.setBounds(271, 77, 104, 23);
		...
		btnSubmitVandalismByUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String folderPath = textFolerPathVandalismByUser.getText();
					try {
						Operation.getVandalismByUser(folderPath, user);
					} catch (ClientHandlerException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					} catch (UniformInterfaceException e1) {
		...
		buttonShowVandalismByArticle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int counter=0;
					...
					try {
						resultList = Operation.showVandalismByTitle(title);
						if(resultList.size()!=0){
							for(int i=0;i<resultList.size();i++){
								counter++;
								model.addRow(resultList.get(i));
					...
					tableVandalismByArticle.getColumnModel().getColumn(0).setPreferredWidth(110);
					tableVandalismByArticle.getColumnModel().getColumn(2).setPreferredWidth(130);
					tableVandalismByArticle.getColumnModel().getColumn(4).setPreferredWidth(100);
			}
		});
		...
		btnGoToVandalismByArticle.setEnabled(false);
		listenTable(tableVandalismByArticle, btnGoToVandalismByArticle);
		btnGoToVandalismByArticle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableVandalismByArticle);
			}
		});
		btnGoToVandalismByArticle.setBounds(275, 75, 99, 23);
		...
		buttonSubmitVandalismByTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String title = textTitleVandalismByTitle.getText();
					try {
						Operation.getVandalismByTitle(folderPath, title);
					} catch (ClientHandlerException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					} catch (UniformInterfaceException e1) {
		...
		btnHowManyTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String countTitle = Operation.countTitle();
		...
		btnHowManyRevisions.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String revisionNumber = Operation.getTheNumberOfRevision();
...
//				textAreaShowAllTitles.setText(listTitle);
				...
				List<Object[]> resultList;				
					try {
						resultList = Operation.listTitle();
						if(resultList.size()!=0){
							for(int i=0;i<resultList.size();i++){
								model.addRow(resultList.get(i));
							}
				...
				tableShowAllTitles.getColumnModel().getColumn(0).setPreferredWidth(170);
			}
		});
		...
		btnGoToGetAllTitles.setEnabled(false);
		listenTable(tableShowAllTitles, btnGoToGetAllTitles);
		btnGoToGetAllTitles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableShowAllTitles);
			}
		});
		btnGoToGetAllTitles.setBounds(66, 48, 104, 23);
		...
		btnFindUserListByTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					userStatistics = Operation.getUserListByTitle(articleName);
				} catch (ClientHandlerException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (UniformInterfaceException e1) {
...
//				textAreaCountTitle.setText(titleUserNumber);
				...
				List<Object[]> resultList;				
					try {
						resultList = Operation.countTitleUserNumber();
						if(resultList.size()!=0){
							for(int i=0;i<resultList.size();i++){
								model.addRow(resultList.get(i));
							}
				...
				tableCountTitle.getColumnModel().getColumn(0).setPreferredWidth(131);
		...
		btnGoToNumberOfUsers.setEnabled(false);
		listenTable(tableCountTitle, btnGoToNumberOfUsers);
		btnGoToNumberOfUsers.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableCountTitle);				
			}
		});
		btnGoToNumberOfUsers.setBounds(83, 46, 108, 23);
		...
		scrollPane_10.setBounds(10, 82, 181, 505);
		panel_22.add(scrollPane_10);
		
		tableCountVandalism = new JTable();
		tableCountVandalism.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		scrollPane_10.setViewportView(tableCountVandalism);
		...
		btnVandalismNumber.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DefaultTableModel model = new DefaultTableModel();
				model.addColumn("title");
				model.addColumn("number of vandalism");
				List<Object[]> resultlist;
				try {
					resultlist = Operation.countTitleVandalismNumber();
					if(resultlist.size()!=0){
						for(int i = 0; i<resultlist.size(); i++){
							model.addRow(resultlist.get(i));
						}
				...
				tableCountVandalism.setModel(model);
				tableCountVandalism.getColumnModel().getColumn(0).setPreferredWidth(131);
		...
		JButton button_2 = new JButton("link to wiki");
		button_2.setEnabled(false);
		listenTable(tableCountVandalism, button_2);
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				goToUrl(tableCountVandalism);
			}
		});
		button_2.setBounds(87, 48, 104, 23);
		panel_22.add(button_2);
...
//		
		...
		btnSubmitContris.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Operation.GetContributionsByUserOffline(user, folderPath);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}					
...
//				labelGetContrisByUser.setText(userCount);
				...
				int counter=0;
				try {
					resultList = Operation.showContrisByUser(userName);
					if(resultList.size()!=0){
						for(int i=0;i<resultList.size();i++){
							counter++;
							model.addRow(resultList.get(i));
				...
				tableGetContrisByUser.getColumnModel().getColumn(0).setPreferredWidth(110);
				tableGetContrisByUser.getColumnModel().getColumn(2).setPreferredWidth(130);
				tableGetContrisByUser.getColumnModel().getColumn(3).setPreferredWidth(100);
			}
		});
		...
		listenTable(tableGetContrisByUser, btnGoTo);
		btnGoTo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				goToUrl(tableGetContrisByUser);
			}
		});
		btnGoTo.setBounds(276, 78, 108, 23);
...
//	//=======================================get title information start================================================================	
		...
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Operation.getArticleInfoByTitleOffline(title, folderPath);
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
...
//				labelFieldGetInfoByArticle.setText(articleCount);
				...
				int counter=0;
				try {
					resultList = Operation.showRevisionInfoByTitle(title);
					if(resultList.size()!=0){
						for(int i=0;i<resultList.size();i++){
							counter++;
							model.addRow(resultList.get(i));
				...
				tableGetInfoByArticle.getColumnModel().getColumn(0).setPreferredWidth(110);
				tableGetInfoByArticle.getColumnModel().getColumn(2).setPreferredWidth(130);
				tableGetInfoByArticle.getColumnModel().getColumn(3).setPreferredWidth(100);
		...
		btnGoToGetInfoByArticle.setEnabled(false);
		listenTable(tableGetInfoByArticle, btnGoToGetInfoByArticle);
		btnGoToGetInfoByArticle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableGetInfoByArticle);
			}
		});
		btnGoToGetInfoByArticle.setBounds(270, 80, 107, 23);
		panel_24.add(btnGoToGetInfoByArticle);
		
		JPanel recommend = new JPanel();
		tabbedPane.addTab("Recommend", null, recommend, null);
		recommend.setLayout(null);
		
		JPanel panel_26 = new JPanel();
		panel_26.setLayout(null);
		panel_26.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Interest", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_26.setBounds(10, 11, 201, 596);
		recommend.add(panel_26);
		
		JScrollPane scrollPane_13 = new JScrollPane();
		scrollPane_13.setBounds(10, 120, 181, 465);
		panel_26.add(scrollPane_13);
		
		tableInterest = new JTable();
		tableInterest.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		scrollPane_13.setViewportView(tableInterest);
		
		JButton button_1 = new JButton("link to wiki");
		button_1.setEnabled(false);
		listenTable(tableInterest, button_1);
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableInterest);
			}
		});
		button_1.setBounds(102, 86, 89, 23);
		panel_26.add(button_1);
		
		textInterestName = new JTextField();
		textInterestName.setColumns(10);
		textInterestName.setBounds(10, 51, 181, 20);
		panel_26.add(textInterestName);
		
		JButton buttonInterest = new JButton("Submit");
		buttonInterest.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<Object[]> resultList;				
					try {
						String user = textInterestName.getText();					
						resultList = Operation.InterestTitle(user);
					...
					tableInterest.setModel(model);
					tableInterest.getColumnModel().getColumn(0).setPreferredWidth(181);
			}
		});
		
		listenOneText(textInterestName, buttonInterest);
		
		buttonInterest.setEnabled(false);
		buttonInterest.setBounds(10, 86, 89, 23);
		panel_26.add(buttonInterest);
		
		JLabel lblNewLabel_1 = new JLabel("User name:");
		lblNewLabel_1.setBounds(10, 26, 89, 14);
		panel_26.add(lblNewLabel_1);
		
		JPanel panel_27 = new JPanel();
		panel_27.setLayout(null);
		panel_27.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Recommendation", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		panel_27.setBounds(221, 11, 201, 596);
		recommend.add(panel_27);
		
		JScrollPane scrollPane_14 = new JScrollPane();
		scrollPane_14.setBounds(10, 120, 181, 465);
		panel_27.add(scrollPane_14);
		
		tableRecommendation = new JTable();
		tableRecommendation.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		scrollPane_14.setViewportView(tableRecommendation);
		
		JButton button = new JButton("link to wiki");
		button.setEnabled(false);
		listenTable(tableRecommendation, button);
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				goToUrl(tableRecommendation);
			}
		});
		button.setBounds(102, 86, 89, 23);
		panel_27.add(button);
		
		textRecommendation = new JTextField();
		textRecommendation.setColumns(10);
		textRecommendation.setBounds(10, 51, 181, 20);
		panel_27.add(textRecommendation);
		
		JButton buttonRecommend = new JButton("Submit");
		buttonRecommend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
				String user = textRecommendation.getText();
				...
				List<Object[]> resultList;				
					try {
						resultList = Operation.recommendTitle(user);
						if(resultList.size()!=0){
							for(int i=0;i<resultList.size();i++){
								model.addRow(resultList.get(i));
							}
					...
					tableRecommendation.setModel(model);
					tableRecommendation.getColumnModel().getColumn(0).setPreferredWidth(110);
				
			}
		});
		
		listenOneText(textRecommendation, buttonRecommend);
		
		buttonRecommend.setEnabled(false);
		buttonRecommend.setBounds(10, 86, 89, 23);
		panel_27.add(buttonRecommend);
		
		JLabel label_22 = new JLabel("User name:");
		label_22.setBounds(10, 26, 89, 14);
	...
	//=======================================data panel end================================================================	
		...
		buttonFindNodeNumberByUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String nodeNumber = Operation.findNodeNumberByUserName(user);
		...
		btnFindLatestArticleTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					revisionLatestEdit = Operation.findArticleLatestInfo(title);
				} catch (ClientHandlerException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				} catch (UniformInterfaceException e) {
		...
		buttonFindRevisionInfoByRevid.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					revInfo = Operation.findRevisionInfoByRevid(revid);
				} catch (ClientHandlerException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (UniformInterfaceException e1) {
		...
		buttonFindLatestUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					userLatestEdit = Operation.findUserLastestInfo(user);
				} catch (ClientHandlerException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (UniformInterfaceException e1) {
		...
		buttonFindRevisionByTitleAndUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String revisonByTitleAndUser = new String();
						try {
							revisonByTitleAndUser = Operation.findRevisionByTitleAndUser(title, user);
						} catch (ClientHandlerException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						} catch (UniformInterfaceException e1) {
		...
		buttonFindUserByRevid.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					userList = Operation.findUserByRevid(revid);
				} catch (ClientHandlerException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				} catch (UniformInterfaceException e1) {
...
//	
	...
	public static void listenTable(final JTable jTable, final JButton jButton){
		jTable.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
            public void valueChanged(ListSelectionEvent e) {
                //push button bl=true; release button bl=false
